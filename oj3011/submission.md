...
```text
โจทย์ให้เเยกสีหรือถ้าสีหนึ่งผสมกับสีหนี่งจะได้สีอะไร
Input:
โปรแกรมรับค่าข้อความ
โปรแกรมรับค่าข้อความ
Output:
โปรแกรมควรพิมพ์สีที่ผสมได้ ไม่ได้ให้พิมพ์ "Error"
Constraints:
ข้อความควรใส่ " " หรือ ' '
```
...
```text
Step 1:โปรแกรมรับค่าข้อความ
Step 2:ถ้าสีเเดง เเละ สีเหลือง ผสมกันจะได้ สีส้ม
Step 3:ถ้าสีเเดง เเละ สีฟ้า ผสมกันจะได้ สีม่วง
Step 4:ถ้าสีเหลือง เเละ สีฟ้า ผสมกันจะได้  สีเขียว
Step 5:ถ้าสีเหลือง เเละถ้าสีเหลือง ผสมกันจะได้ สีเหลือง
Step 6:ถ้าสีฟ้า และ สีฟ้า ผสมกันจะได้ สีฟ้า
Step 7::ถ้าสีเเดง เเละ:ถ้าสีเเดง ผสมกันจะได้ สีเเดง
Step 8:ถ้าไม่ใช่สีที่กำหนด ให้พิมพ์ "Error"
Step 9:พิมพ์ตัวเเปรสีที่ผสม
```
...
```text
วิธีสุดท้ายของฉันไม่เหมือนกับแผนแรก เพราะต้องเติมสีสลับกันด้วยจาก เเดงกับฟ้า หรือ ฟ้ากับเเดง ,เเดงกับเหลืองหรือเหลืองกับเเดง,ฟ้ากับเหลืองหรือเหลืองกับฟ้า
```
...
```text
ทดสอบว่าตัวพิมพ์เล็กผลลัพธ์จะออกมาเเบบไหน
```
...
```text
ทดสอบว่าถ้าพิมพ์สีอื่นที่ไม่ได้กำหนดจะได้ผลลัพธ์ออกมายังไง
```
