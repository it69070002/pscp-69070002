...
1000000
Constraints
ต้องตรวจทั้งตัวอักษร เลขทั้งหมด เลข 2 ตัวท้าย และเลข 3 ตัวท้าย โดยเลือกเงื่อนไขรางวัลที่สูงสุดก่อน
```
...
```text
Step 1: รับข้อมูลสลาก 2 ชุด
Step 2: เปรียบเทียบตัวอักษรและหมายเลข
Step 3: ตรวจเลข 3 ตัวท้ายและ 2 ตัวท้าย
Step 4: ตรวจเงื่อนไขรางวัลจากมากไปน้อย
Step 5: แสดงจำนวนเงินรางวัลที่ตรงกับเงื่อนไข
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เปรียบเทียบตัวอักษรและหมายเลขของสลากทั้งสองชุด รวมถึงเลข 2 และ 3 ตัวท้าย แล้วใช้ if-elif ตรวจเงื่อนไขรางวัลจากรางวัลสูงสุดไปต่ำสุด เพื่อแสดงเงินรางวัลที่ถูกต้องตามเงื่อนไข
```
...
```text
ตรวจว่าการตรงเฉพาะตัวอักษรได้รางวัลถูกต้อง
```
