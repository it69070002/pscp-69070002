...
```text
โจทย์ต้องการสลับตัวอักษร
Input:
โปรแกรมรับค่าข้อความ
Output:
โปรแกรมสลับตัวอักษรจากหลังไปหน้า
Constraints:
.lower()เอาไว้ทำให้ข้อความพิมพ์เล็กหมด
```
...
Step 2:ให้พิมพ์ข้อความจากหลังไปหน้า เเละทำให้ข้อความเป็นตัวพิมพ์เล็ก
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะให้พิมพ์ข้อความจากหลังไปหน้า เเละทำให้ข้อความเป็นตัวพิมพ์เล็ก
```
...
```text
ทดสอบว่าตัวพิมพ์ใหญ่ผลลัพธ์จะกลายเป็นพิมพ์เล็กไหม
```
...
```text
อยากทดสอบว่าถ้ามีตัวอักษรเดียวจะเป็นไง
```
